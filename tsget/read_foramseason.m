...
% Auto-generated by MATLAB on 2019/05/17 11:47:49

%% Initialize variables.
filename = 'foramseason.csv';
delimiter = ',';
startRow = 2;
...
foramseason = table;
foramseason.foram = rawStringColumns(:, 1);
foramseason.min = cell2mat(rawNumericColumns(:, 1));
foramseason.max = cell2mat(rawNumericColumns(:, 2));
